...
class Decoder(metaclass=Singleton):
    ...
    @classmethod
    def decode(  # type: ignore[misc,explicit-any]
    ...
    @classmethod
    def _decode(  # type: ignore[misc,explicit-any]
    ...
    @classmethod
    def decode_list(  # type: ignore[misc,explicit-any]
        cls, bytes_obj: bytes, cursor: int, *, decode_utf8: bool
    ) -> tuple[tuple[Any, ...], int]:
        output = []
        cursor += 1
    ...
    @classmethod
    def decode_dict(  # type: ignore[misc,explicit-any]
        cls, bytes_obj: bytes, cursor: int, *, decode_utf8: bool
